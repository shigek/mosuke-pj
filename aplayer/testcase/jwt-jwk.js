...
console.log(new Buffer('eyJqdGkiOiJhYmZlYzhiOC1lMTdkLTRlODctOTA2MS01ZjIxOWEyMGNjYjkiLCJzdWIiOiIxIiwiZXhwIjoxNTI5OTAzMDI4LCJpYXQiOjE1Mjk4OTk0Mjh9', 'Base64').toString());
console.log(new Buffer('MEYCIQCtvut6noRLFrrymleutREZXJZyFC3oB1RHqyN8mUXpbQIhAM7bZSStGYRqt0oJmFWVFAylr_zxFPHIzLFXzm9MOf_X', 'Base64').toString());
